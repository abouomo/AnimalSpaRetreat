...
public class AnimalRetreat {
	...
	/**
	 * Takes an Animal parameter and assigns them to the first empty (null) 
	 * room found at the retreat (the array). 
	 * @param animal
	 */
	...
	/**
	 * Tells its attendant to makeRounds by calling the Attendant's 
	 * makeRounds() method.
	 */
